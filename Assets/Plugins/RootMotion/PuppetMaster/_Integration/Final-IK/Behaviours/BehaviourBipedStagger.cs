...
namespace RootMotion.Dynamics {
    ...
    public partial class BehaviourBipedStagger : BehaviourBase {
        ...
        protected override void OnInitiate() {
            ...
            footsteps[0].OnFootstep.AddListener(OnLeftFootstep);
            footsteps[1].OnFootstep.AddListener(OnRightFootstep);
        ...
        private IEnumerator RegainBalance()
        {
            ...
            while (regainBalanceWeight < 1f)
            {
                ...
                {
                    // Drag
                    m.rigidbody.AddForce(-m.rigidbody.linearVelocity * d, ForceMode.VelocityChange);
